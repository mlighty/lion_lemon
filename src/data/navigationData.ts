  ...
  mainMenu: [
    ...
    },
    {
      ...
      submenu: [
        ...
        { id: 'bmw', label: 'BMW', href: '/bmw-repurchase-lemon-law/' },
        { id: 'chevrolet', label: 'Chevrolet', href: '/chevrolet-repurchase-lemon-law/' },
        { id: 'chrysler', label: 'Chrysler', href: '/chrysler-repurchase-lemon-law/' },
        { id: 'dodge', label: 'Dodge', href: "https://lemonlawexperts.com/dodge-repurchase-lemon-law/" },
        { id: 'ford', label: 'Ford', href: '/ford-repurchase-lemon-law/' },
        { id: 'gmc', label: 'GMC', href: "https://lemonlawexperts.com/gmc-repurchase-lemon-law/" },
        { id: 'honda', label: 'Honda', href: '/honda-repurchase-lemon-law/' },
        { id: 'hyundai', label: 'Hyundai', href: '/hyundai-repurchase-lemon-law/' },
        { id: 'jeep', label: 'Jeep', href: "https://lemonlawexperts.com/jeep-repurchase-lemon-law/" },
        { id: 'kia', label: 'Kia', href: "https://lemonlawexperts.com/kia-repurchase-lemon-law/" },
        { id: 'lexus', label: 'Lexus', href: "https://lemonlawexperts.com/lexus-repurchase-lemon-law/" },
        { id: 'mercedes', label: 'Mercedes Benz', href: '/mercedes-benz-repurchase-lemon-law/' },
        { id: 'nissan', label: 'Nissan', href: '/nissan-repurchase-lemon-law/' },
        { id: 'subaru', label: 'Subaru', href: '/subaru-repurchase-lemon-law/' },
        { id: 'tesla', label: 'Tesla', href: "https://lemonlawexperts.com/tesla-lemon-law-information/" },
        { id: 'toyota', label: 'Toyota', href: '/toyota-repurchase-lemon-law/' },
        { id: 'volkswagen', label: 'Volkswagen', href: "https://lemonlawexperts.com/volkswagen-repurchase-lemon-law/" },
        { id: 'all', label: 'All Manufacturers', href: "https://lemonlawexperts.com/all-manufacturers/" }
      ]
    },
    {
      id: 'locations',
